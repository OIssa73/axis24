      ...
      <main className="container mx-auto px-4 py-32 max-w-7xl animate-in fade-in duration-700">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed italic border-l-4 border-primary/40 pl-8 py-2 font-light break-words min-w-0 w-full overflow-hidden text-left md:text-justify">
              {content.description}
            </p>
          </motion.div>
