      ...
      <main className="container mx-auto px-4 py-32 max-w-7xl animate-in fade-in duration-700">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed italic border-l-4 border-primary/40 pl-8 py-2 font-light break-words max-w-full text-justify [text-justify:inter-word]">
              {content.description}
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-[1fr,240px] gap-16">
            ...
            >
              <div className="space-y-10 text-xl leading-[1.7] text-foreground/80 whitespace-pre-wrap font-sans break-words max-w-full overflow-hidden [word-break:break-word] text-justify [text-justify:inter-word]">
