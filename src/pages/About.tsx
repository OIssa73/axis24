    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-32 max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto italic text-left md:text-justify min-w-0 w-full break-words px-2">
        ...
        {loading ? (
          ...
          <motion.div
            ...
            className="prose prose-invert prose-primary max-w-none 
              ...
              prose-p:text-lg prose-p:leading-relaxed prose-p:text-muted-foreground prose-p:text-left md:prose-p:text-justify prose-p:break-words prose-p:min-w-0 prose-p:w-full
